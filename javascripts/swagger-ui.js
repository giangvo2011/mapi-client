...
//      }
    ...
    submitOperation: function() {
      ...
      if (error_free) {
        ...
        if(this.operation.httpMethodLowercase == "get"){
    ...
    showStatus: function(data) {
      ...
      if(jsonData.status == "success"){
    	  $(".response_code", this.elementScope + "_content_sandbox_response").html("<pre>" + "OK" + "</pre>");
      }else{
    	  $(".response_code", this.elementScope + "_content_sandbox_response").html("<pre>" + jsonData.error_code + "</pre>");  
      }
